...
modbus_registers[4]=(signed char)(bps[0]._Ti>>8);			//Рег3	Температура радиатора выпрямителя №1, 1гЦ
modbus_registers[5]=(signed char)(bps[0]._Ti);
modbus_registers[6]=(signed char)(bps[0]._av>>8);			//Рег4	Байт флагов выпрямителя №1, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[7]=(signed char)(bps[0]._av);
modbus_registers[8]=(signed char)(bps[1]._Uii>>8);			//Рег5	Выходное напряжение выпрямителя №2, 0.1В
modbus_registers[9]=(signed char)(bps[1]._Uii);
modbus_registers[10]=(signed char)(bps[1]._Ii>>8);			//Рег6	Выходной ток выпрямителя №2, 0.1А
modbus_registers[11]=(signed char)(bps[1]._Ii);
modbus_registers[12]=(signed char)(bps[1]._Ti>>8);			//Рег7	Температура радиатора выпрямителя №2, 1гЦ
modbus_registers[13]=(signed char)(bps[1]._Ti);
modbus_registers[14]=(signed char)(bps[1]._av>>8);			//Рег8	Байт флагов выпрямителя №2, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[15]=(signed char)(bps[1]._av);
modbus_registers[16]=(signed char)(bps[2]._Uii>>8);			//Рег9	Выходное напряжение выпрямителя №3, 0.1В
modbus_registers[17]=(signed char)(bps[2]._Uii);
modbus_registers[18]=(signed char)(bps[2]._Ii>>8);			//Рег10	Выходной ток выпрямителя №3, 0.1А
modbus_registers[19]=(signed char)(bps[2]._Ii);
modbus_registers[20]=(signed char)(bps[2]._Ti>>8);			//Рег11	Температура радиатора выпрямителя №3, 1гЦ
modbus_registers[21]=(signed char)(bps[2]._Ti);
modbus_registers[22]=(signed char)(bps[2]._av>>8);			//Рег12	Байт флагов выпрямителя №3, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[23]=(signed char)(bps[2]._av);
modbus_registers[24]=(signed char)(bps[3]._Uii>>8);			//Рег13	Выходное напряжение выпрямителя №4, 0.1В
modbus_registers[25]=(signed char)(bps[3]._Uii);
modbus_registers[26]=(signed char)(bps[3]._Ii>>8);			//Рег14	Выходной ток выпрямителя №4, 0.1А
modbus_registers[27]=(signed char)(bps[3]._Ii);
modbus_registers[28]=(signed char)(bps[3]._Ti>>8);			//Рег15	Температура радиатора выпрямителя №4, 1гЦ
modbus_registers[29]=(signed char)(bps[3]._Ti);
modbus_registers[30]=(signed char)(bps[3]._av>>8);			//Рег16	Байт флагов выпрямителя №4, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[31]=(signed char)(bps[3]._av);
modbus_registers[32]=(signed char)(bps[4]._Uii>>8);			//Рег17	Выходное напряжение выпрямителя №5, 0.1В
modbus_registers[33]=(signed char)(bps[4]._Uii);
modbus_registers[34]=(signed char)(bps[4]._Ii>>8);			//Рег18	Выходной ток выпрямителя №5, 0.1А
modbus_registers[35]=(signed char)(bps[4]._Ii);
modbus_registers[36]=(signed char)(bps[4]._Ti>>8);			//Рег19	Температура радиатора выпрямителя №5, 1гЦ
modbus_registers[37]=(signed char)(bps[4]._Ti);
modbus_registers[38]=(signed char)(bps[4]._av>>8);			//Рег20	Байт флагов выпрямителя №5, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[39]=(signed char)(bps[4]._av);
modbus_registers[40]=(signed char)(bps[5]._Uii>>8);			//Рег21	Выходное напряжение выпрямителя №6, 0.1В
modbus_registers[41]=(signed char)(bps[5]._Uii);
modbus_registers[42]=(signed char)(bps[5]._Ii>>8);			//Рег22	Выходной ток выпрямителя №6, 0.1А
modbus_registers[43]=(signed char)(bps[5]._Ii);
modbus_registers[44]=(signed char)(bps[5]._Ti>>8);			//Рег23	Температура радиатора выпрямителя №6, 1гЦ
modbus_registers[45]=(signed char)(bps[5]._Ti);
modbus_registers[46]=(signed char)(bps[5]._av>>8);			//Рег24	Байт флагов выпрямителя №6, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[47]=(signed char)(bps[5]._av);
modbus_registers[48]=(signed char)(bps[6]._Uii>>8);			//Рег25	Выходное напряжение выпрямителя №7, 0.1В
modbus_registers[49]=(signed char)(bps[6]._Uii);
modbus_registers[50]=(signed char)(bps[6]._Ii>>8);			//Рег26	Выходной ток выпрямителя №7, 0.1А
modbus_registers[51]=(signed char)(bps[6]._Ii);
modbus_registers[52]=(signed char)(bps[6]._Ti>>8);			//Рег27	Температура радиатора выпрямителя №7, 1гЦ
modbus_registers[53]=(signed char)(bps[6]._Ti);
modbus_registers[54]=(signed char)(bps[6]._av>>8);			//Рег28	Байт флагов выпрямителя №7, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[55]=(signed char)(bps[6]._av);
modbus_registers[56]=(signed char)(bps[7]._Uii>>8);			//Рег29	Выходное напряжение выпрямителя №8, 0.1В
modbus_registers[57]=(signed char)(bps[7]._Uii);
modbus_registers[58]=(signed char)(bps[7]._Ii>>8);			//Рег30	Выходной ток выпрямителя №8, 0.1А
modbus_registers[59]=(signed char)(bps[7]._Ii);
modbus_registers[60]=(signed char)(bps[7]._Ti>>8);			//Рег31	Температура радиатора выпрямителя №8, 1гЦ
modbus_registers[61]=(signed char)(bps[7]._Ti);
modbus_registers[62]=(signed char)(bps[7]._av>>8);			//Рег32	Байт флагов выпрямителя №8, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[63]=(signed char)(bps[7]._av);
modbus_registers[64]=(signed char)(bps[8]._Uii>>8);			//Рег33	Выходное напряжение выпрямителя №9, 0.1В
modbus_registers[65]=(signed char)(bps[8]._Uii);
modbus_registers[66]=(signed char)(bps[8]._Ii>>8);			//Рег34	Выходной ток выпрямителя №9, 0.1А
modbus_registers[67]=(signed char)(bps[8]._Ii);
modbus_registers[68]=(signed char)(bps[8]._Ti>>8);			//Рег35	Температура радиатора выпрямителя №9, 1гЦ
modbus_registers[69]=(signed char)(bps[8]._Ti);
modbus_registers[70]=(signed char)(bps[8]._av>>8);			//Рег36	Байт флагов выпрямителя №9, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[71]=(signed char)(bps[8]._av);
modbus_registers[72]=(signed char)(bps[9]._Uii>>8);			//Рег37	Выходное напряжение выпрямителя №10, 0.1В
modbus_registers[73]=(signed char)(bps[9]._Uii);
modbus_registers[74]=(signed char)(bps[9]._Ii>>8);			//Рег38	Выходной ток выпрямителя №10, 0.1А
modbus_registers[75]=(signed char)(bps[9]._Ii);
modbus_registers[76]=(signed char)(bps[9]._Ti>>8);			//Рег39	Температура радиатора выпрямителя №10, 1гЦ
modbus_registers[77]=(signed char)(bps[9]._Ti);
modbus_registers[78]=(signed char)(bps[9]._av>>8);			//Рег40	Байт флагов выпрямителя №10, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[79]=(signed char)(bps[9]._av);
modbus_registers[80]=(signed char)(bps[10]._Uii>>8);		//Рег41	Выходное напряжение выпрямителя №11, 0.1В
modbus_registers[81]=(signed char)(bps[10]._Uii);
modbus_registers[82]=(signed char)(bps[10]._Ii>>8);			//Рег42	Выходной ток выпрямителя №11, 0.1А
modbus_registers[83]=(signed char)(bps[10]._Ii);
modbus_registers[84]=(signed char)(bps[10]._Ti>>8);			//Рег43	Температура радиатора выпрямителя №11, 1гЦ
modbus_registers[85]=(signed char)(bps[10]._Ti);
modbus_registers[86]=(signed char)(bps[10]._av>>8);			//Рег44	Байт флагов выпрямителя №11, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[87]=(signed char)(bps[10]._av);
modbus_registers[88]=(signed char)(bps[11]._Uii>>8);		//Рег45	Выходное напряжение выпрямителя №12, 0.1В
modbus_registers[89]=(signed char)(bps[11]._Uii);
modbus_registers[90]=(signed char)(bps[11]._Ii>>8);			//Рег46	Выходной ток выпрямителя №12, 0.1А
modbus_registers[91]=(signed char)(bps[11]._Ii);
modbus_registers[92]=(signed char)(bps[11]._Ti>>8);			//Рег47	Температура радиатора выпрямителя №12, 1гЦ
...
modbus_registers[100]=(signed char)	(in_U>>8);				//Рег51	Входное напряжение системы
...
modbus_registers[108]=(signed char)	(avar_vd_stat>>8);		//Рег55	 Флаг аварий системы
modbus_registers[109]=(signed char)	(avar_vd_stat);			// Бит 0 - авария одного из БПС
...
modbus_registers[118]=(signed char)(bps[12]._Uii>>8);			//Рег60	Выходное напряжение выпрямителя №13, 0.1В
modbus_registers[119]=(signed char)(bps[12]._Uii);
modbus_registers[120]=(signed char)(bps[12]._Ii>>8);			//Рег61	Выходной ток выпрямителя №13, 0.1А
modbus_registers[121]=(signed char)(bps[12]._Ii);
modbus_registers[122]=(signed char)(bps[12]._Ti>>8);			//Рег62	Температура радиатора выпрямителя №13, 1гЦ
modbus_registers[123]=(signed char)(bps[12]._Ti);
modbus_registers[124]=(signed char)(bps[12]._av>>8);			//Рег63	Байт флагов выпрямителя №13, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[125]=(signed char)(bps[12]._av);
modbus_registers[126]=(signed char)(bps[13]._Uii>>8);			//Рег64	Выходное напряжение выпрямителя №14, 0.1В
modbus_registers[127]=(signed char)(bps[13]._Uii);
modbus_registers[128]=(signed char)(bps[13]._Ii>>8);			//Рег65	Выходной ток выпрямителя №14, 0.1А
modbus_registers[129]=(signed char)(bps[13]._Ii);
modbus_registers[130]=(signed char)(bps[13]._Ti>>8);			//Рег66	Температура радиатора выпрямителя №14, 1гЦ
modbus_registers[131]=(signed char)(bps[13]._Ti);
modbus_registers[132]=(signed char)(bps[13]._av>>8);			//Рег67	Байт флагов выпрямителя №14, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[133]=(signed char)(bps[13]._av);
modbus_registers[134]=(signed char)(bps[14]._Uii>>8);			//Рег68	Выходное напряжение выпрямителя №15, 0.1В
modbus_registers[135]=(signed char)(bps[14]._Uii);
modbus_registers[136]=(signed char)(bps[14]._Ii>>8);			//Рег69	Выходной ток выпрямителя №15, 0.1А
modbus_registers[137]=(signed char)(bps[14]._Ii);
modbus_registers[138]=(signed char)(bps[14]._Ti>>8);			//Рег70	Температура радиатора выпрямителя №15, 1гЦ
modbus_registers[139]=(signed char)(bps[14]._Ti);
modbus_registers[140]=(signed char)(bps[14]._av>>8);			//Рег71	Байт флагов выпрямителя №15, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[141]=(signed char)(bps[14]._av);
modbus_registers[142]=(signed char)(bps[15]._Uii>>8);			//Рег72	Выходное напряжение выпрямителя №16, 0.1В
modbus_registers[143]=(signed char)(bps[15]._Uii);
modbus_registers[144]=(signed char)(bps[15]._Ii>>8);			//Рег73	Выходной ток выпрямителя №16, 0.1А
modbus_registers[145]=(signed char)(bps[15]._Ii);
modbus_registers[146]=(signed char)(bps[15]._Ti>>8);			//Рег74	Температура радиатора выпрямителя №16, 1гЦ
modbus_registers[147]=(signed char)(bps[15]._Ti);
modbus_registers[148]=(signed char)(bps[15]._av>>8);			//Рег75	Байт флагов выпрямителя №16, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[149]=(signed char)(bps[15]._av);
modbus_registers[150]=(signed char)(bps[16]._Uii>>8);			//Рег76	Выходное напряжение выпрямителя №17, 0.1В
modbus_registers[151]=(signed char)(bps[16]._Uii);
modbus_registers[152]=(signed char)(bps[16]._Ii>>8);			//Рег77	Выходной ток выпрямителя №17, 0.1А
modbus_registers[153]=(signed char)(bps[16]._Ii);
modbus_registers[154]=(signed char)(bps[16]._Ti>>8);			//Рег78	Температура радиатора выпрямителя №17, 1гЦ
modbus_registers[155]=(signed char)(bps[16]._Ti);
modbus_registers[156]=(signed char)(bps[16]._av>>8);			//Рег79	Байт флагов выпрямителя №17, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[157]=(signed char)(bps[16]._av);
modbus_registers[158]=(signed char)(bps[17]._Uii>>8);			//Рег80	Выходное напряжение выпрямителя №18, 0.1В
modbus_registers[159]=(signed char)(bps[17]._Uii);
modbus_registers[160]=(signed char)(bps[17]._Ii>>8);			//Рег81	Выходной ток выпрямителя №18, 0.1А
modbus_registers[161]=(signed char)(bps[17]._Ii);
modbus_registers[162]=(signed char)(bps[17]._Ti>>8);			//Рег82	Температура радиатора выпрямителя №18, 1гЦ
modbus_registers[163]=(signed char)(bps[17]._Ti);
modbus_registers[164]=(signed char)(bps[17]._av>>8);			//Рег83	Байт флагов выпрямителя №18, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[165]=(signed char)(bps[17]._av);
modbus_registers[166]=(signed char)(bps[18]._Uii>>8);			//Рег84	Выходное напряжение выпрямителя №19, 0.1В
modbus_registers[167]=(signed char)(bps[18]._Uii);
modbus_registers[168]=(signed char)(bps[18]._Ii>>8);			//Рег85	Выходной ток выпрямителя №19, 0.1А
modbus_registers[169]=(signed char)(bps[18]._Ii);
modbus_registers[170]=(signed char)(bps[18]._Ti>>8);			//Рег86	Температура радиатора выпрямителя №19, 1гЦ
modbus_registers[171]=(signed char)(bps[18]._Ti);
modbus_registers[172]=(signed char)(bps[18]._av>>8);			//Рег87	Байт флагов выпрямителя №19, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[173]=(signed char)(bps[18]._av);
modbus_registers[174]=(signed char)(bps[19]._Uii>>8);			//Рег88	Выходное напряжение выпрямителя №20, 0.1В
modbus_registers[175]=(signed char)(bps[19]._Uii);
modbus_registers[176]=(signed char)(bps[19]._Ii>>8);			//Рег89	Выходной ток выпрямителя №20, 0.1А
modbus_registers[177]=(signed char)(bps[19]._Ii);
modbus_registers[178]=(signed char)(bps[19]._Ti>>8);			//Рег90	Температура радиатора выпрямителя №20, 1гЦ
modbus_registers[179]=(signed char)(bps[19]._Ti);
modbus_registers[180]=(signed char)(bps[19]._av>>8);			//Рег91	Байт флагов выпрямителя №20, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[181]=(signed char)(bps[19]._av);
modbus_registers[182]=(signed char)(bps[20]._Uii>>8);			//Рег92	Выходное напряжение выпрямителя №21, 0.1В
modbus_registers[183]=(signed char)(bps[20]._Uii);
modbus_registers[184]=(signed char)(bps[20]._Ii>>8);			//Рег93	Выходной ток выпрямителя №21, 0.1А
modbus_registers[185]=(signed char)(bps[20]._Ii);
modbus_registers[186]=(signed char)(bps[20]._Ti>>8);			//Рег94	Температура радиатора выпрямителя №21, 1гЦ
modbus_registers[187]=(signed char)(bps[20]._Ti);
modbus_registers[188]=(signed char)(bps[20]._av>>8);			//Рег95	Байт флагов выпрямителя №21, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[189]=(signed char)(bps[20]._av);
modbus_registers[190]=(signed char)(bps[21]._Uii>>8);			//Рег96	Выходное напряжение выпрямителя №22, 0.1В
modbus_registers[191]=(signed char)(bps[21]._Uii);
modbus_registers[192]=(signed char)(bps[21]._Ii>>8);			//Рег97	Выходной ток выпрямителя №22, 0.1А
modbus_registers[193]=(signed char)(bps[21]._Ii);
modbus_registers[194]=(signed char)(bps[21]._Ti>>8);			//Рег98	Температура радиатора выпрямителя №22, 1гЦ
modbus_registers[195]=(signed char)(bps[21]._Ti);
modbus_registers[196]=(signed char)(bps[21]._av>>8);			//Рег99	Байт флагов выпрямителя №22, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[197]=(signed char)(bps[21]._av);
modbus_registers[198]=(signed char)(bps[22]._Uii>>8);			//Рег100	Выходное напряжение выпрямителя №23, 0.1В
modbus_registers[199]=(signed char)(bps[22]._Uii);
modbus_registers[200]=(signed char)(bps[22]._Ii>>8);			//Рег101	Выходной ток выпрямителя №23, 0.1А
modbus_registers[201]=(signed char)(bps[22]._Ii);
modbus_registers[202]=(signed char)(bps[22]._Ti>>8);			//Рег102	Температура радиатора выпрямителя №23, 1гЦ
modbus_registers[203]=(signed char)(bps[22]._Ti);
modbus_registers[204]=(signed char)(bps[22]._av>>8);			//Рег103	Байт флагов выпрямителя №23, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[205]=(signed char)(bps[22]._av);
modbus_registers[206]=(signed char)(bps[23]._Uii>>8);			//Рег104	Выходное напряжение выпрямителя №24, 0.1В
modbus_registers[207]=(signed char)(bps[23]._Uii);
modbus_registers[208]=(signed char)(bps[23]._Ii>>8);			//Рег105	Выходной ток выпрямителя №24, 0.1А
modbus_registers[209]=(signed char)(bps[23]._Ii);
modbus_registers[210]=(signed char)(bps[23]._Ti>>8);			//Рег106	Температура радиатора выпрямителя №24, 1гЦ
modbus_registers[211]=(signed char)(bps[23]._Ti);
modbus_registers[212]=(signed char)(bps[23]._av>>8);			//Рег107	Байт флагов выпрямителя №24, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[213]=(signed char)(bps[23]._av);
modbus_registers[214]=(signed char)(bps[24]._Uii>>8);			//Рег108	Выходное напряжение выпрямителя №25, 0.1В
modbus_registers[215]=(signed char)(bps[24]._Uii);
modbus_registers[216]=(signed char)(bps[24]._Ii>>8);			//Рег109	Выходной ток выпрямителя №25, 0.1А
modbus_registers[217]=(signed char)(bps[24]._Ii);
modbus_registers[218]=(signed char)(bps[24]._Ti>>8);			//Рег110	Температура радиатора выпрямителя №25, 1гЦ
modbus_registers[219]=(signed char)(bps[24]._Ti);
modbus_registers[220]=(signed char)(bps[24]._av>>8);			//Рег111	Байт флагов выпрямителя №25, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[221]=(signed char)(bps[24]._av);
modbus_registers[222]=(signed char)(bps[25]._Uii>>8);			//Рег112	Выходное напряжение выпрямителя №26, 0.1В
modbus_registers[223]=(signed char)(bps[25]._Uii);
modbus_registers[224]=(signed char)(bps[25]._Ii>>8);			//Рег113	Выходной ток выпрямителя №26, 0.1А
modbus_registers[225]=(signed char)(bps[25]._Ii);
modbus_registers[226]=(signed char)(bps[25]._Ti>>8);			//Рег114	Температура радиатора выпрямителя №26, 1гЦ
modbus_registers[227]=(signed char)(bps[25]._Ti);
modbus_registers[228]=(signed char)(bps[25]._av>>8);			//Рег115	Байт флагов выпрямителя №26, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[229]=(signed char)(bps[25]._av);
modbus_registers[230]=(signed char)(bps[26]._Uii>>8);			//Рег116	Выходное напряжение выпрямителя №27, 0.1В
modbus_registers[231]=(signed char)(bps[26]._Uii);
modbus_registers[232]=(signed char)(bps[26]._Ii>>8);			//Рег117	Выходной ток выпрямителя №27, 0.1А
modbus_registers[233]=(signed char)(bps[26]._Ii);
modbus_registers[234]=(signed char)(bps[26]._Ti>>8);			//Рег118	Температура радиатора выпрямителя №27, 1гЦ
modbus_registers[235]=(signed char)(bps[26]._Ti);
modbus_registers[236]=(signed char)(bps[26]._av>>8);			//Рег119	Байт флагов выпрямителя №27, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[237]=(signed char)(bps[26]._av);
modbus_registers[238]=(signed char)(bps[27]._Uii>>8);			//Рег120	Выходное напряжение выпрямителя №28, 0.1В
modbus_registers[239]=(signed char)(bps[27]._Uii);
modbus_registers[240]=(signed char)(bps[27]._Ii>>8);			//Рег121	Выходной ток выпрямителя №28, 0.1А
modbus_registers[241]=(signed char)(bps[27]._Ii);
modbus_registers[242]=(signed char)(bps[27]._Ti>>8);			//Рег122	Температура радиатора выпрямителя №28, 1гЦ
modbus_registers[243]=(signed char)(bps[27]._Ti);
modbus_registers[244]=(signed char)(bps[27]._av>>8);			//Рег123	Байт флагов выпрямителя №28, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[245]=(signed char)(bps[27]._av);
modbus_registers[246]=(signed char)(bps[28]._Uii>>8);			//Рег124	Выходное напряжение выпрямителя №29, 0.1В
modbus_registers[247]=(signed char)(bps[28]._Uii);
modbus_registers[248]=(signed char)(bps[28]._Ii>>8);			//Рег125	Выходной ток выпрямителя №29, 0.1А
modbus_registers[249]=(signed char)(bps[28]._Ii);
modbus_registers[250]=(signed char)(bps[28]._Ti>>8);			//Рег126	Температура радиатора выпрямителя №29, 1гЦ
modbus_registers[251]=(signed char)(bps[28]._Ti);
modbus_registers[252]=(signed char)(bps[28]._av>>8);			//Рег127	Байт флагов выпрямителя №29, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[253]=(signed char)(bps[28]._av);
modbus_registers[254]=(signed char)(bps[29]._Uii>>8);			//Рег128	Выходное напряжение выпрямителя №30, 0.1В
modbus_registers[255]=(signed char)(bps[29]._Uii);
modbus_registers[256]=(signed char)(bps[29]._Ii>>8);			//Рег129	Выходной ток выпрямителя №30, 0.1А
modbus_registers[257]=(signed char)(bps[29]._Ii);
modbus_registers[258]=(signed char)(bps[29]._Ti>>8);			//Рег130	Температура радиатора выпрямителя №30, 1гЦ
modbus_registers[259]=(signed char)(bps[29]._Ti);
modbus_registers[260]=(signed char)(bps[29]._av>>8);			//Рег131	Байт флагов выпрямителя №30, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[261]=(signed char)(bps[29]._av);
modbus_registers[262]=(signed char)(bps[30]._Uii>>8);			//Рег132	Выходное напряжение выпрямителя №31, 0.1В
modbus_registers[263]=(signed char)(bps[30]._Uii);
modbus_registers[264]=(signed char)(bps[30]._Ii>>8);			//Рег133	Выходной ток выпрямителя №31, 0.1А
modbus_registers[265]=(signed char)(bps[30]._Ii);
modbus_registers[266]=(signed char)(bps[30]._Ti>>8);			//Рег134	Температура радиатора выпрямителя №31, 1гЦ
modbus_registers[267]=(signed char)(bps[30]._Ti);
modbus_registers[268]=(signed char)(bps[30]._av>>8);			//Рег135	Байт флагов выпрямителя №31, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
modbus_registers[269]=(signed char)(bps[30]._av);
modbus_registers[270]=(signed char)(bps[31]._Uii>>8);			//Рег136	Выходное напряжение выпрямителя №32, 0.1В
modbus_registers[271]=(signed char)(bps[31]._Uii);
modbus_registers[272]=(signed char)(bps[31]._Ii>>8);			//Рег137	Выходной ток выпрямителя №32, 0.1А
modbus_registers[273]=(signed char)(bps[31]._Ii);
modbus_registers[274]=(signed char)(bps[31]._Ti>>8);			//Рег138	Температура радиатора выпрямителя №32, 1гЦ
modbus_registers[275]=(signed char)(bps[31]._Ti);
modbus_registers[276]=(signed char)(bps[31]._av>>8);			//Рег139	Байт флагов выпрямителя №32, 0x01 - перегрев, 0x02 завышено Uвых, 0x04 занижено Uвых, 0x08 - отсутствует связь с выпрямителем
