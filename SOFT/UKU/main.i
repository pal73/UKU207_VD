...
if(sub_cnt1>=20)
	...
	int2lcdyx(bps[a_ind . s_i1]._av,0,4,0);
	...
	int2lcdyx(lc640_read_int(ADR_EE_RELE_SET_MASK[a_ind . s_i1]),0,19,0);
	int2lcdyx(RELE_SET_MASK[a_ind . s_i1],0,12,0);
	int2lcdyx(a_ind . s_i1,0,2,0);  
	}
...
#line 7363 "main.c"
    ...
    else if((a_ind . s_i==23) || (a_ind . s_i==3))
		{
		if(but==254)
		     {
		     tree_down(0,0);
